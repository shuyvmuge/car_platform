		...
		data() {
			return {
				...
				success:{
					type:'default',
					message:"登录成功",
					iconUrl:'@/static/imgs/@/static/imgs/success.png'
				},
				success:{
					type:'success',
					message:"登录成功",
