		...
		<view class="page_car_header">
			<view class="header_content">
				<view class="left">
					...
					<text class="sub_title">高效管理、精准拓客、数字化经营</text>
					<text class="btn">使用教程</text>
				</view>
				<view>
					<image src="/static/imgs/right.png" style="width: 131px;height: 122px;"></image>
				</view>
			</view>
		</view>
